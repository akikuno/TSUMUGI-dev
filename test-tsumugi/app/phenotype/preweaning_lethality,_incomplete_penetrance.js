...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/preweaning_lethality,_incomplete_penetrance.json.gz", false);
...
const file_name = 'TSUMUGI_preweaning_lethality,_incomplete_penetrance';
