...
const elements = loadJSONGz("../../data/phenotype/preweaning_lethality,_complete_penetrance.json.gz");
...
let target_phenotype = "preweaning lethality, complete penetrance";
...
const file_name = "TSUMUGI_preweaning_lethality,_complete_penetrance";
