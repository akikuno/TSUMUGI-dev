...
const elements = loadJSONGz("../../data/phenotype/convulsive_seizures.json.gz");
...
let target_phenotype = "convulsive seizures";
...
const file_name = "TSUMUGI_convulsive_seizures";
