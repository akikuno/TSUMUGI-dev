...
const elements = loadJSONGz("../../data/phenotype/increased_circulating_glycerol_level.json.gz");
...
let target_phenotype = "increased circulating glycerol level";
...
const file_name = "TSUMUGI_increased_circulating_glycerol_level";
