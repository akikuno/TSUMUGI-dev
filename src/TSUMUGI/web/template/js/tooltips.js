...
function createTooltip(event, cy, map_symbol_to_id, target_phenotype = null, nodeColorMin = null, nodeColorMax = null, edgeMin = null, edgeMax = null, allNodeColors = null) {
...
*/
export function showTooltip(event, cy, map_symbol_to_id, target_phenotype = null, nodeColorMin = null, nodeColorMax = null, edgeMin = null, edgeMax = null, allNodeColors = null) {
    removeTooltips();

    const { tooltipText, pos } = createTooltip(event, cy, map_symbol_to_id, target_phenotype, nodeColorMin, nodeColorMax, edgeMin, edgeMax, allNodeColors);
